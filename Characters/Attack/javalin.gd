...
var spr_jav_reg = preload("res://art/Sprout Lands - Sprites - Basic pack/Objects/javelin_3_new.png")
var spr_jav_atk = preload("res://art/Sprout Lands - Sprites - Basic pack/Objects/javelin_3_new_attack.png")
