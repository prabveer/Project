...
const ICON_PATH = "res://art/Sprout Lands - Sprites - Basic pack/Upgrades/"
const WEAPON_PATH = "res://art/Sprout Lands - Sprites - Basic pack/Weapons/"
const UPGRADES = {
	"carrot1": {
		"icon": WEAPON_PATH + "carrot.png",
		"displayname": "Carrot",
		"details": "A carrot is thrown at a random enemy",
		"level": "Level: 1",
		"prerequisite": [],
		"type": "weapon"
	},
	"carrot2": {
		"icon": WEAPON_PATH + "carrot.png",
		"displayname": "Carrot",
		"details": "An addition carrot is thrown",
		"level": "Level: 2",
		"prerequisite": ["carrot1"],
		"type": "weapon"
	},
	"carrot3": {
		"icon": WEAPON_PATH + "carrot.png",
		"displayname": "Carrot",
		"details": "Carrots now pass through another enemy and do + 3 damage",
		"level": "Level: 3",
		"prerequisite": ["carrot2"],
		"type": "weapon"
	},
	"carrot4": {
		"icon": WEAPON_PATH + "carrot.png",
		"displayname": "Carrot",
		"details": "An additional 2 carrot are thrown",
		"level": "Level: 4",
		"prerequisite": ["carrot3"],
		"type": "weapon"
	},
	"javelin1": {
